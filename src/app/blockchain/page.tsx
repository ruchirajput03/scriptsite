        ...
        <>
            ...
            <section className='lg:px-[80px] px-[40px] lg:pt-[150px] pt-[150px] overflow-hidden'>
                <div className='col-lg-6'>
                    <h1 className="lg:text-[60px] sm:text-[40px] font-bold mb-4 text-[20px] lg:leading-[65px] sm:leading-[45px] leading-[25px]">
            ...
            <section className="lg:px-[80px] px-[40px]  lg:pt-[80px] pt-[40px]" >
                ...
                <div className="flex flex-wrap items-center">
                    ...
                    <div className="col-lg-6 order-lg-1 order-2 lg:pt-[80px] pt-[40px] ">
                        ...
                        <h1 className="lg:text-[35px] font-semibold sm:text-[30px] col-lg-10 text-[20px]  uppercase  lg:leading-[40px] sm:leading-[45px] leading-[35px] ">
                    ...
                    <div className="col-lg-6 lg:pt-[80px] pt-[40px] lg:sticky lg:max-h-screen lg:top-[200px]  order-lg-2 order-1">
                    ...
                    <div className="col-lg-6 ">
                        <div className="flex justify-center">
                            <div className="col-lg-10 lg:pt-[80px] pt-[40px]">
                                <div className="pb-3 mt-3 col-lg-6 font-semibold uppercase text-gray-400">Blockchain development</div>
                                <h1 className="lg:text-[40px] sm:text-[30px] uppercase text-[20px] font-semibold text-white leading-[1]">
                                    DApp Development
                                </h1>
                    ...
                    >
                        <div className="flex justify-center">
                            <div className="col-lg-10">
                                ...
                                <h1 className="lg:text-[40px] font-semibold uppercase col-lg-7 sm:text-[35px] text-[26px] lg:leading-[45px]">
            ...
            <section className=" lg:px-[80px] px-[40px]  lg:pt-[80px] pt-[40px] ">
                <div className="flex flex-wrap items-center ">
                    ...
                    <div className="col-lg-6 w-full order-lg-2 order-1 lg:sticky lg:max-h-screen lg:top-[200px] " data-aos="fade-left"
                    >
                    ...
                    <div className="col-lg-6 mb-4 lg:pt-[80px] pt-[40px]" 
                        ...
                        <div className="flex justify-center">
                            <div className="col-lg-10">
                                ...
                                <h1 className="lg:text-[40px] uppercase col-lg-7 font-semibold sm:text-[35px] text-[26px] lg:leading-[45px]">
