            ...
            >
              <div className="col-lg-6 mb-4" >
                <div className="col-lg-12">
                  <video className="relative w-full rounded-md" autoPlay
                    loop
                    muted
                    playsInline
                    preload="auto"  >
          ...
          <div className="container-fluid ">
            ...
            <div className="row justify-center pt-4" >
              <div className="col-md-12">
                <video className="relative w-full rounded-lg h-[40vw]" autoPlay
                  loop
                  muted
                  playsInline
                  preload="auto">
          ...
          <div className="row relative">
            <div className=" flex justify-center  ">
              <div className="col-lg-5">
                <Image className=" text-center w-full rounded-md" src="/assets/Rectangle 10.png"
                  alt="..."
                  width={300}
                  height={100}
                />
