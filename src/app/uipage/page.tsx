        ...
        <>
            ...
            <section className="lg:px-[80px] px-[40px]  lg:pt-[80px] pt-[40px]">
                ...
                <div className="flex flex-wrap items-center ">
                    ...
                    <div className="col-lg-6 order-lg-1 order-2 g:pt-[80px] pt-[40px]">
                        ...
                        <h1 className="lg:text-[40px] font-semibold sm:text-[30px] text-[20px] uppercase  lg:leading-[40px] sm:leading-[45px] leading-[35px] ">
                    ...
                    <div className="col-lg-6  order-lg-2 order-1 lg:sticky lg:max-h-screen lg:top-[200px]">
                    ...
                    <div className="col-lg-6 ">
                        <div className="flex justify-center">
                            <div className="col-lg-10 lg:pt-[80px] pt-[40px]">
                                ...
                                <h1 className="lg:text-[40px] font-semibold sm:text-[30px] text-[20px]  text-white leading-[1]">
                                    OUR <br></br>EXPERTISE
                                </h1>
                    ...
                    <div className="col-lg-6 order-lg-1 order-2 lg:pt-[80px] pt-[40px]">
                        <div className="flex justify-center">
                            <div className="col-lg-10">
                                ...
                                <h1 className="lg:text-[40px] sm:text-[30px] font-semibold text-[22px] uppercase text-white leading-[1]">
            ...
            <section className="  lg:px-[80px] px-[40px]  lg:pt-[80px] pt-[40px]">
                <div className="row items-center">
                    ...
                    <div className="col-lg-6 order-lg-1 order-2 lg:pt-[80px] pt-[40px]">
                        <div className="flex justify-center">
                            <div className="col-lg-10">
                                ...
                                <h1 className="lg:text-[40px] font-semibold sm:text-[30px] text-[22px] uppercase text-white leading-[1]">
                    ...
                    <div className="col-lg-6 w-full pt-4  order-lg-2 order-1  lg:sticky lg:max-h-screen lg:top-[200px]">
            ...
            <section className="lg:px-[80px] px-[40px] lg:pt-[80px] pt-[40px]">
                <div className="row items-center lg:sticky lg:max-h-screen lg:top-[200px] ">
                    ...
                    <div className="col-md-6 lg:pt-[80px] pt-[40px]">
                        <div className="flex justify-center">
                            <div className="col-lg-10">
                                ...
                                <h1 className="lg:text-[40px] font-semibold sm:text-[35px] uppercase text-[26px] leading-[1]">
            ...
            <section className="lg:px-[80px] px-[40px]  lg:pt-[80px] pt-[40px] ">
                <div className="row items-center">
                    ...
                    <div className="col-lg-6 mt-4 w-full order-lg-2 order-1 lg:sticky lg:max-h-screen lg:top-[200px]">
