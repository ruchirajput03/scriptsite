        ...
        <div className=" text-[#EEEEEE]">
          <div className="flex pt-10 mb-4 gap-4" >
            <div className="col-lg-3  ">
              <p className="lg:text-[1vw] text-[3vw]  lg:leading-[1vw] leading-[4vw]">In our design arena, productivity commands the show, and revenue applauds the finale.</p>
            </div>
            <div className="col-lg-6  ">

              <p className="lg:text-[1vw] text-[3vw] font-bold lg:leading-[1vw] leading-[4vw]">Actions Over Words: Solutions <br></br>That Deliver!</p>
            </div>
          </div>
        </div>
        ...
        <div className=" text-[#EEEEEE]">
          <div className="flex pt-10  mb-4 gap-12" >
            <div className="col-lg-4  ">
              ...
              <p className="lg:text-[1vw] text-[2.5vw]  lg:leading-[1vw] leading-[4vw]">IN 7 YEARS, OUR TEAM HAS ACHIEVED IMPACTFUL RESULTS FOR OVER 100 STARTUP BUSINESSES.</p> 
               <div className="col-lg-4    ">
            ...
            <div className="col-lg-8">
              ...
              <p className="lg:text-[1.9vw] text-[3vw] font-semibold flex justify-end lg:leading-[2vw] leading-[3.5vw]">We’re a powerhouse of creative minds, crafting brilliance with every idea.</p>
            </div>
          </div>
        </div>
